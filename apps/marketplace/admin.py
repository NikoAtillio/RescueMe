...
from .models import Animal, RescueCenter, Contact, SpecialNeed, LivingRequirement
...
class ContactAdmin(admin.ModelAdmin):
    list_display = ('name', 'rescue_center', 'phone_number', 'email')
    list_filter = ('rescue_center',)
